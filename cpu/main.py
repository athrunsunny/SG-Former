...
from labeled_memcached_dataset1 import McDataset
import sgformer
...
parser.add_argument('--data', default=r'G:\hand_classify_data\1207data\1207custom_hand', metavar='DIR',
                    help='path to dataset')
parser.add_argument('--model', default='sgformer_s', type=str, metavar='MODEL',
...
def main():
    ...
    model = sgformer.__dict__[args.model](drop_path_rate=args.drop_path,num_classes=args.num_classes)
    ...
    if args.jsd:
        ...
        train_loss_fn = JsdCrossEntropy(num_splits=num_aug_splits, smoothing=args.smoothing).to(device)
    elif mixup_active:
